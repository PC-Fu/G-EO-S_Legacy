...
{
  if( rank==0 ){
    std::cout << "GEOS Version 2.2" << std::endl;
    std::cout << "                            " << std::endl;
...
void DisplaySplash(int rank)
{
  if( rank==0 ){
    ...
    std::cout << "############################" << std::endl;
    std::cout << "                            " << std::endl;
    std::cout << "  GEOS Version 2.2 (Alpha)  " << std::endl;
    std::cout << "   Snapshot on 12/11/2014   " << std::endl;
    std::cout << "  geoscore commit e1a8392   " << std::endl;
    std::cout << "   gmodb commit 7c058d8     " << std::endl;
    std::cout << "############################" << std::endl;
    std::cout << "                            " << std::endl;
  }
}
